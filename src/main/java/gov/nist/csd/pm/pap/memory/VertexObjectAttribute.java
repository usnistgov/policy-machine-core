...
class VertexObjectAttribute implements Vertex {
    ...
    public VertexObjectAttribute(String name, Map<String, String> properties) {
    ...
    private VertexObjectAttribute(Node node, List<String> parents, List<String> children, List<Association> associations) {
    ...
    @Override
    public Vertex copy() {
        return new VertexObjectAttribute(node, parents, children, associations);
    }
