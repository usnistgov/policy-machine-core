...
public interface ProhibitionsStore extends Prohibitions {
     ...
     *
     * @throws ProhibitionExistsException If a prohibition with the given id already exists.
     ...
     */
    @Override
    void create(String id, ProhibitionSubject subject, AccessRightSet accessRightSet,
     ...
     *
     * @throws ProhibitionDoesNotExistException If a prohibition with the given id does not exist.
     * @throws ProhibitionSubjectDoesNotExistException If the defined prohibition subject does not exist.
     * @throws ProhibitionContainerDoesNotExistException If a defined container does not exist.
     * @throws UnknownAccessRightException If a provided access right is unknown.
     * @throws PMBackendException If there is an error executing the command in the PIP.
     */
    @Override
    void update(String id, ProhibitionSubject subject, AccessRightSet accessRightSet,
                                boolean intersection, ContainerCondition... containerConditions)
     ...
     */
    @Override
    Prohibition get(String id) throws ProhibitionDoesNotExistException, PMBackendException;

    /**
     * Check the prohibition being created.
     *
     * @param graph The GraphStore used to check the subject and containers exist.
     * @param id The id of the prohibition.
     ...
     * @throws PMBackendException If there is an error executing the command in the PIP.
     * @throws ProhibitionExistsException If there already exists a prohibition with the same id.
     ...
     */
    default void checkCreateInput(GraphStore graph, String id, ProhibitionSubject subject, AccessRightSet accessRightSet, boolean intersection , ContainerCondition ... containerConditions)
    throws PMBackendException, ProhibitionExistsException, UnknownAccessRightException, ProhibitionSubjectDoesNotExistException, ProhibitionContainerDoesNotExistException {
        if (exists(id)) {
            throw new ProhibitionExistsException(id);
        }
     ...
     * @throws ProhibitionContainerDoesNotExistException If the container node does not exist.
     */
    default void checkUpdateInput(GraphStore graph, String id, ProhibitionSubject subject, AccessRightSet accessRightSet, boolean intersection , ContainerCondition ... containerConditions)
