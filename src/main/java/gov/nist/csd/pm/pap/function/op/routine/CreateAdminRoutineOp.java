...
public class CreateAdminRoutineOp extends Operation<Void> {
    ...
    public static final FormalArg<Routine<?>> ROUTINE_ARG = new FormalArg<>("routine", new RoutineType());
    ...
    public Args actualArgs(Routine<?> routine) {
        Args args = new Args();
        args.put(ROUTINE_ARG, routine);
        return args;
    }

    @Override
    public Void execute(PAP pap, Args args) throws PMException {
        Routine<?> routine = args.get(ROUTINE_ARG);
