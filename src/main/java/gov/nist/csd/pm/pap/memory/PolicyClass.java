...
class PolicyClass implements Vertex {

    private final Node node;
    private final List<String> children;

    public PolicyClass(String name, Map<String, String> properties) {
        this.node = new Node(name, NodeType.PC, properties);
        this.children = new ArrayList<>();
    }

    private PolicyClass(Node node, List<String> children) {
    ...
    @Override
    public Vertex copy() {
        return new PolicyClass(node, children);
    }
