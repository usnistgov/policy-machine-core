...
class VertexUser implements Vertex {

    private final Node node;
    private final List<String> parents;

    public VertexUser(String name, Map<String, String> properties) {
        this.node = new Node(name, NodeType.U, properties);
        this.parents = new ArrayList<>();
    }

    private VertexUser(Node node, List<String> parents) {
    ...
    @Override
    public Vertex copy() {
        return new VertexUser(node, parents);
    }
