...
public interface Decider {
     ...
     */
    boolean hasPermissions(long userID, long targetID, String... perms) throws PMException;
     ...
     * @throws PMException if there is an exception traversing the graph.
     */
    Set<String> listPermissions(long userID, long targetID) throws PMException;
     ...
     */
    Collection<Long> filter(long userID, Collection<Long> nodes, String... perms) throws PMException;
     ...
     * @throws PMException if there is an exception traversing the graph.
     */
    Collection<Long> getChildren(long userID, long targetID, String... perms) throws PMException;
