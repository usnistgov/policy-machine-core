...
public class GraphModifier extends Modifier implements GraphModification {
    ...
    public long createPolicyClass(String name) throws PMException {
        ...
        id = generateUniqueId(id, name, PC);
    ...
    /**
     * Retry id generation on collision, bounded so a degenerate {@link IdGenerator} fails fast
     * instead of looping forever.
     *
     * @param id   The first candidate id, already generated by the caller.
     ...
     */
    private long generateUniqueId(long id, String name, NodeType type) throws PMException {
    ...
    throws PMException {
        ...
        final long uniqueId = generateUniqueId(id, name, type);
