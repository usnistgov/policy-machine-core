...
import gov.nist.csd.pm.core.pap.pml.antlr.PMLParser.AnyTypeContext;
...
import gov.nist.csd.pm.core.pap.pml.antlr.PMLParser.NodeTypeContext;
...
public class TypeResolver {
    ...
    public static Type<?> resolveFromParserCtx(PMLParser.VariableTypeContext ctx) {
        return switch (ctx) {
            ...
            case NodeTypeContext nodeTypeContext -> BasicTypes.NODE_TYPE;
