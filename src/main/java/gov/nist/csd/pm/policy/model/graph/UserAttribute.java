...
class UserAttribute implements Vertex {
    ...
    public UserAttribute(String name, Map<String, String> properties) {
    ...
    private UserAttribute(Node node, List<String> parents, List<String> children, List<Association> outgoing, List<Association> incoming) {
    ...
    @Override
    public Vertex copy() {
        return new UserAttribute(node, parents, children, outgoingAssociations, incomingAssociations);
    }
