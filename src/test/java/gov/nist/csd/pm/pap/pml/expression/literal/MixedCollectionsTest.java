 ...
 * These tests ensure that collections with OBJECT_TYPE as element or value type
...
public class MixedCollectionsTest {
    ...
    void testMixedArrayCreation() throws PMException {
        ...
        assertEquals(listType(OBJECT_TYPE), array.getType());
    ...
    void testMixedArrayFromPML() throws PMException {
        ...
        Expression<?> expression = ExpressionVisitor.compile(visitorContext, ctx, listType(OBJECT_TYPE));
        
        // Verify no compilation errors
        assertEquals(0, visitorContext.errorLog().getErrors().size());
        assertTrue(expression instanceof ArrayLiteralExpression);
        assertEquals(listType(OBJECT_TYPE), expression.getType());
    ...
    void testMixedMapCreation() throws PMException {
        ...
        assertEquals(mapType(STRING_TYPE, OBJECT_TYPE), map.getType());
    ...
    void testMixedMapFromPML() throws PMException {
        ...
        VisitorContext visitorContext = new VisitorContext(new CompileScope());
        Expression<?> expression = ExpressionVisitor.compile(visitorContext, ctx, mapType(STRING_TYPE, OBJECT_TYPE));
        
        // Verify no compilation errors
        assertEquals(0, visitorContext.errorLog().getErrors().size());
        assertTrue(expression instanceof MapLiteralExpression);
        assertEquals(mapType(STRING_TYPE, OBJECT_TYPE), expression.getType());
    ...
    void testMixedMapKeysFromPML() throws PMException {
        ...
        VisitorContext visitorContext = new VisitorContext(new CompileScope());
        Expression<?> expression = ExpressionVisitor.compile(visitorContext, ctx, mapType(OBJECT_TYPE, STRING_TYPE));
        
        // Verify no compilation errors
        assertEquals(0, visitorContext.errorLog().getErrors().size());
        assertTrue(expression instanceof MapLiteralExpression);
        assertEquals(mapType(OBJECT_TYPE, STRING_TYPE), expression.getType());
    ...
    void testEmptyCollections() throws PMException {
        ...
        Expression<?> mapExpr = ExpressionVisitor.compile(visitorContext, mapCtx, mapType(OBJECT_TYPE, OBJECT_TYPE));
    ...
    void testCollectionTypeCasting() throws PMException {
        ...
        Expression<Map<String, Object>> objectMap = stringMap.asType(mapType(STRING_TYPE, OBJECT_TYPE));
