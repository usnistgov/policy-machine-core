...
public class ExecutionTest {
    ...
    void testForeach() throws PMException {
        ...
        String input = "foreach x in [\"pc1\", \"pc2\", \"pc3\"] {\n" +
        ...
        input = "var m = {\"k1\": \"pc1\", \"k2\": \"pc2\", \"k3\": \"pc3\"}\n" +
                "                foreach x, y in m {\n" +
        ...
        input = "foreach x, y in {\"k1\": [\"pc1\", \"pc2\"], \"k2\": [\"pc3\"]} {\n" +
                "                    foreach z in y {\n" +
    ...
    void testFunction() throws PMException {
        String input = "operation testFunc(any x) {\n" +
                "                    create policy class x\n" +
                "                }\n" +
                "                \n" +
                "                testFunc(\"pc1\")";
        ...
        String input1 = "operation testFunc(any x) {\n" +
                "                    create policy class x\n" +
                "                }\n" +
                "                \n" +
                "                testFunc([\"pc1\"])";
    ...
    void testMaps() throws PMException {
        String input = "var m = {\"k1\": {\"k1-1\": {\"k1-1-1\": \"v1\"}}}\n" +
    ...
    void testArrayWithLiteral() throws PMException {
        ...
        String input1 = "set resource operations [[\"read\", \"write\"], [\"exec\"]]";
    ...
    void testDeleteProhibition() throws PMException {
        ...
        String input = "create prohibition \"p1\"\n" +
    ...
    void testReturnValue() throws PMException {
        String pml = "operation testFunc(string s) string {\n" +
                "                    return s\n" +
                "                }\n" +
                "                \n" +
