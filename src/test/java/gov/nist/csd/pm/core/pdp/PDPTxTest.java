...
class PDPTxTest {
    ...
    void testReset() throws PMException {
        ...
        pap.executePML(new UsernameContext("u1"), """
                ...
                """);
        PDPTx u2 = new PDPTx(new UserIdContext(id("u2")), pap, List.of());
        assertThrows(UnauthorizedException.class, u2::reset);

        PDPTx u1 = new PDPTx(new UsernameContext("u1"), pap, List.of());
    ...
    void testPrivilegesOnNodesCreatedInPC() throws PMException {
        ...
        PDPTx pdpTx = new PDPTx(new UserIdContext(u1), pap, List.of());
    ...
    void testObligationAuthorNoPrivilegesOnEventContextUser() throws PMException {
        ...
        testPAP.executePML(new UsernameContext("u1"), """
