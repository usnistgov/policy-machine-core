...
import gov.nist.ngac.pm.core.pap.obligation.event.subject.SubjectPatternExpression;
...
import gov.nist.ngac.pm.core.pap.pml.antlr.PMLParser.AnyOperationContext;
import gov.nist.ngac.pm.core.pap.pml.antlr.PMLParser.EventPatternContext;
import gov.nist.ngac.pm.core.pap.pml.antlr.PMLParser.OnPatternContext;
import gov.nist.ngac.pm.core.pap.pml.antlr.PMLParser.OperationPatternFuncContext;
import gov.nist.ngac.pm.core.pap.pml.compiler.Variable;
import gov.nist.ngac.pm.core.pap.pml.compiler.error.CompileError;
import gov.nist.ngac.pm.core.pap.pml.compiler.visitor.operation.StatementBlockParser;
...
/**
 * Compiles a PML create obligation statement into a {@link CreateObligationStatement}.
 */
        ...
        public OperationPattern visitOperationPatternFunc(OperationPatternFuncContext ctx) {
            ...
            try {
                ...
                return new MatchesOperationPattern(
                    ...
                    new OnPattern(
                        argNames,
                        new PMLStmtsRoutine<>(opName, BOOLEAN_TYPE, patternParams, pmlStatementBlock)
                    )
                );
