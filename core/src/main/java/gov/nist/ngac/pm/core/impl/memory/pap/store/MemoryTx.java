...
/**
 * Tracks the active state of a transaction on a {@link MemoryPolicyStore}. Supports
 * nested transactions from a single thread but is not designed for concurrent use.
 */
