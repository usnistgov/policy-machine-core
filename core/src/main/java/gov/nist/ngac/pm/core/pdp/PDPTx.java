...
import gov.nist.ngac.pm.core.pdp.modification.PolicyModificationAdjudicator;
import gov.nist.ngac.pm.core.pdp.query.PolicyQueryAdjudicator;
...
public class PDPTx implements OperationExecutor {
     ...
     *
     * @param userCtx the user to build the context for
     * @throws PMException if building the context fails
     */
    ...
    /**
     * Executes a PML string. Returns null if the PML has no return statement.
     *
     * @param input the PML to execute
    ...
    /**
     * Serializes the current policy state.
     *
     * @param serializer used to serialize the policy
    ...
    /**
     * Deserializes the given input and applies it to the policy.
     *
     * @param input the serialized policy
     * @param policyDeserializer used to deserialize the input
    ...
    /**
     * Executes the given obligation response.
     *
     * @param eventCtx the event that triggered the obligation
