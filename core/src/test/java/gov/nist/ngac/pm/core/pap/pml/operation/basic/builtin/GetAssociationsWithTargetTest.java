...
import gov.nist.ngac.pm.core.pap.pml.operation.builtin.GetAssociationsWithTarget;
...
class GetAssociationsWithTargetTest {
    ...
    void testOk() throws PMException {
        ...
        List<Map<String, Object>> result = getAssociationsWithTarget.execute(pap.query(), null,
            new Args(Map.of(NODE_NAME_PARAM, "oa1")));
